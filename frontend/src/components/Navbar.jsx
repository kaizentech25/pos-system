      ...
      <div className="px-4 md:px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-2">
              ...
              {!isAdmin && canAnalytics && (
                <Link to="/analytics" className={navLinkClass('/analytics')}>
                  <LayoutDashboard size={18} className="inline mr-1" /> Business Intelligence
                </Link>
              )}
          </div>
        ...
        {menuOpen && (
          <div className="md:hidden mt-4 pt-4 border-t border-gray-200 dark:border-gray-700 space-y-2">
              ...
              {/* Business Intelligence (Analytics) - Manager only */}
              {canAnalytics && (
                <Link to="/analytics" onClick={() => setMenuOpen(false)} className={navLinkClass('/analytics') + ' block'}>
                  <LayoutDashboard size={18} className="inline mr-1" /> Business Intelligence
                </Link>
              )}
              {/* System Monitoring - Admin only */}
